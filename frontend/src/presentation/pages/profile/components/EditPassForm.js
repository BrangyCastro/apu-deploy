...
import { updatePassApi } from "../../../../domain/services";
          ...
          <CCol xs="12" md="6">
            <CFormGroup className="form-group-login">
              ...
              <CIcon
                ...
                onClick={() => myFunction("claveAnt")}
              />
              <span className="text-danger">
                {errors.claveAnt && errors.claveAnt.message}
              </span>
            </CFormGroup>
            <CFormGroup className="form-group-login">
